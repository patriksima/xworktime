...
//
    ...
    class CHelpdeskUkolList extends CObjectList
    {
        ...
        {
            $subquery = "(SELECT prava FROM {$this->table5}
                           WHERE id_zadavatel = u.id_zadavatel
                             AND id_dodavatel = u.id_dodavatel
                             AND typ = u.klic) prava";
            return "SELECT u.*,
