...
//
    ...
    $(document).ready(function(){
        ...
        $('form:first').submit(function(){
            ...
            var re = /^[0-9]+([,|.][0-9]+){0,1}$/
            if ($("form:first #sazbaz").val()=='' && !re.test($("form:first #sazbaz2").val())) {
                $("form:first #sazbaz2").css({backgroundColor:ERR_BGCOLOR});
                $("form:first #sazbaz2").after('<span class="form-error-msg">! Zadejte sazbu pro zadavatele</span>');
            ...
            if (!re.test($("form:first #sazbad").val())) {
                ...
                $("form:first #sazbad").after('<span class="form-error-msg">! Zadejte sazbu pro dodavatele</span>');
            ...
            var re = /^[0-9]+([,|.][0-9]+){0,1}$/
            if (!re.test($("form:first #hodinyz").val())) {
            ...
            if (!re.test($("form:first #splneno").val())) {
                $("form:first #splneno").css({backgroundColor:ERR_BGCOLOR});
                $("form:first #splneno").after('<span class="form-error-msg">! Zadejte datum realizace ve tvaru RRRR-MM-DD</span>');
                $("form:first #splneno").focus();
                return false;
            }
        });
